        ...
        if (request.status == 200) {
            ...
            if (tdata_len !== button_len) {//讓按鈕可以印到所有選到的資料呈現出來為止
                ...
                for (var i = 0; i < button_len; i++) {//t字帳表格建立
                    ...
                    cell0.innerHTML = cell0.innerHTML + "<button id='button_call_open_price_" + i.toString() + "' onclick='show_detail(button_call_open_price_" + i.toString() + ")'>" + '--' + "</button>";//印出按鈕
                    cell1.innerHTML = cell1.innerHTML + "<button id='button_call_close_price_" + i.toString() + "' onclick='show_detail(button_call_close_price_" + i.toString() + ")'>" + '--' + "</button>";
                    cell2.innerHTML = cell2.innerHTML + "<font id='strike_"+ i.toString() +"_data'>" + 'strike' + "</font>";
                    cell3.innerHTML = cell3.innerHTML + "<button id='button_put_open_price_" + i.toString() + "' onclick='show_detail(button_put_open_price_" + i.toString() + ")'>" + '--' + "</button>";
                    cell4.innerHTML = cell4.innerHTML + "<button id='button_put_close_price_" + i.toString() + "' onclick='show_detail(button_put_close_price_" + i.toString() + ")'>" + '--' + "</button>";
                };
