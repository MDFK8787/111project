...
def test():
    if request.method =='POST':
        if request.values['click']=='送出':
            ...
            plt.savfig('pmf.png')
            return render_template('test.html', 'pmf.png')
